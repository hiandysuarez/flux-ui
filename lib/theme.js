...
export const shadows = {
  ...
  lg: '0 8px 24px rgba(0, 0, 0, 0.24), 0 4px 8px rgba(0, 0, 0, 0.12)',
  xl: '0 16px 48px rgba(0, 0, 0, 0.3), 0 8px 16px rgba(0, 0, 0, 0.15)',
  glow: '0 0 20px rgba(212, 165, 116, 0.15)',
  glowStrong: '0 0 30px rgba(212, 165, 116, 0.25)',
  inner: 'inset 0 1px 0 rgba(240, 246, 252, 0.04)',
  card: '0 1px 3px rgba(0, 0, 0, 0.12), 0 8px 24px rgba(0, 0, 0, 0.2), inset 0 1px 0 rgba(240, 246, 252, 0.04)',
};
...
export const visualEffects = {
  ...
  // Glow effects with gold
  dataGlow: '0 0 20px rgba(212, 165, 116, 0.2)',
  dataGlowStrong: '0 0 30px rgba(212, 165, 116, 0.35)',
  errorGlow: '0 0 20px rgba(248, 81, 73, 0.25)',
  successGlow: '0 0 20px rgba(63, 185, 80, 0.25)',

  // Gradient for risk visualization
  dangerGradient: 'linear-gradient(90deg, #F85149 0%, #D29922 25%, #3FB950 50%, #D29922 75%, #F85149 100%)',
  safeZoneGradient: 'linear-gradient(90deg, #F85149 0%, #D29922 15%, #3FB950 35%, #3FB950 65%, #D29922 85%, #F85149 100%)',
  ...
  // Card gradient
  cardGradient: 'linear-gradient(135deg, #161B22 0%, #0D1117 100%)',
};
...
// Card - with gradient and sophisticated shadows
export const cardStyle = {
  background: visualEffects.cardGradient,
...
export const cardHoverStyle = {
  ...
  boxShadow: `${shadows.card}, ${shadows.glow}`,
};
